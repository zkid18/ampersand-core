"""ampersand-admin vec-rebuild — backfill the semantic search index.
...
from ampersand_core.embeddings import EMBED_DIM, Embedder
from ampersand_core.search import VectorIndex, VectorIndexer
from ampersand_core.search.parser import parse_sections
from ampersand_core.search.vec_index import (
    hash_section,
