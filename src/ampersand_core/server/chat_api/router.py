...
from ampersand_core.server.chat_api.schemas import ChatRequest
...
from ampersand_core.store import MarkdownStore, NotFound
    ...
    if not key:
        raise HTTPException(
            ...
            detail=(
                ...
                "Add it to /etc/ampersand/env and restart ampersand-server."
            ),
        )
    return key
...
def chat(
    ...
    model = payload.model or os.environ.get("AMPERSAND_CHAT_MODEL") or DEFAULT_MODEL
